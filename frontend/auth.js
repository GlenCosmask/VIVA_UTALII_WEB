...
class AuthSystem {
    ...
    async login(email, password) {
        try {
            const response = await fetch('https://siphonal-corny-dawson.ngrok-free.dev/login', {
                method: 'POST',
                headers: {
    ...
    async signup(name, email, password) {
        try {
            const response = await fetch('https://siphonal-corny-dawson.ngrok-free.dev/signup', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    requireAuth(redirectTo = '../backend/login.html') {
        if (!this.isLoggedIn()) {
